...
def run_european_strategy_comparison():
    """
    EXPERIMENT 2: Strategy Comparison on EUROPEAN Roulette
    Compare Flat Betting vs Martingale strategy on European roulette
    """
    print("🎯 EXPERIMENT 2: Strategy Comparison - EUROPEAN Roulette")
    print("=" * 65)
    
    # Use European roulette
    wheel_type = "european"
    ...
    fig.savefig('strategy_comparison_european_enhanced.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt_original.savefig('strategy_comparison_european_original.png', dpi=300, bbox_inches='tight')
    plt_original.show()
